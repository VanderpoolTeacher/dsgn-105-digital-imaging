#!/usr/bin/env python3
"""
Build the DSGN 105 student site.
...
PUBLISHED
  ...
  01_design/          glossary · rubrics/competency-rubric
                      · assessments/awareness-campaign-{student-brief,rubric,rubric-critique}
...
WITHHELD
  ...
  01_design/          course-specification · course-outline · assessment-evidence
                      ...
                      · assessments/awareness-campaign-instructor-guide
...
COURSE_DIR = pathlib.Path(os.environ.get("DSGN105_COURSE", DEFAULT_COURSE_DIR)).resolve()
SRC = COURSE_DIR / "02_source"
DESIGN = COURSE_DIR / "01_design"

COURSE = "DSGN 105"
COURSE_LONG = "Digital Imaging"
...
REFERENCE = [
    ...
    ("assessments/awareness-campaign-student-brief.md", "reference/campaign-brief.html",
     "Campaign brief", "What the awareness campaign is and what it must contain."),
    ("assessments/awareness-campaign-rubric.md", "reference/campaign-rubric.html",
     "Campaign rubric", "How the campaign is marked."),
    ("assessments/awareness-campaign-rubric-critique.md",
     "reference/critique-rubric.html",
     "Critique rubric", "How the critique sessions are marked."),
]

NUMBER_WORD = {8: "eight", 10: "ten", 12: "twelve", 14: "fourteen", 15: "fifteen", 16: "sixteen"}
...
def main():
    if not SRC.is_dir():
        sys.exit(f"source not found: {SRC}\nSet DSGN105_COURSE to override.")
